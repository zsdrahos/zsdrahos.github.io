...
<!--------------------------------------------- MAIN PART --------------------------------------------->	
    <div class="col-sm-8 text-left kozep">
		<h1>Contact</h1>
			<br>
			<p>László Drahos, Károly Vékey<br>
			Research Centre for Natural Sciences<br>
			Magyar tudósok körútja 2<br>
			H-1117, Budapest, Hungary<br>
			<br>
			<p> <span class="vastag">Phone:</span> +36 1 382 6542<br>
			
			 <span class="vastag">E-mail: </span><a href="mailto:proteomics@ttk.hu">proteomics@ttk.hu </a></p>
	 </div>
<!------------------------------------------- MAIN PART END ------------------------------------------->	
